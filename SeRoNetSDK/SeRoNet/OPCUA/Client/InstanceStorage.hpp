...
namespace SeRoNet {
	namespace OPCUA {
		namespace Client {
			...
			template <typename INSTANCE_TYPE_T>
			inline typename InstanceStorage<INSTANCE_TYPE_T>::Instance_Container_Iterator_t InstanceStorage<INSTANCE_TYPE_T>::add(INSTANCE_TYPE_T* inst)
			{
