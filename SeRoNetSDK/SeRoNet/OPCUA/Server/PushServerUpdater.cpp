...
class UpdateOpcuaServerVisitor :
 ...
 public:
  ...
  explicit UpdateOpcuaServerVisitor(std::shared_ptr<SeRoNet::OPCUA::Server::OpcUaServer> pOpcUaServer, const open62541Cpp::UA_NodeId &parent)
  ...
  void visit(SeRoNet::CommunicationObjects::Description::ElementPrimitive<bool> *el) override {
    ...
    auto myVariant = open62541Cpp::UA_Variant();
    auto value = el->get();
  ...
  void visit(SeRoNet::CommunicationObjects::Description::ElementPrimitive<std::string> *el) override {
    ...
    auto myVariant = open62541Cpp::UA_Variant();
    auto value = el->get();
    open62541Cpp::UA_String tmp = open62541Cpp::UA_String(value);
